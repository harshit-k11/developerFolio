  ...
  experience: [
    {
      ...
      descBullets: [
        ...
        "Optimized data retrieval in DynamoDB, reducing query time from 5 seconds to 2 seconds",
        "Implemented secure user authentication via AWS Cognito, reducing onboarding time by 20%",
        "Transformed a Tax Management application using Angular and Material UI, resolving over 150 system bugs"
      ]
    },
    {
